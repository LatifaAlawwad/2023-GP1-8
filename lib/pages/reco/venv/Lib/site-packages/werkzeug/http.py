...
def parse_date(value: str | None) -> datetime | None:
    ...
    This is a wrapper for :func:`email.utils.dart.parsedate_to_datetime`. It
    ...
    .. versionchanged:: 2.0
        ...
        ``email.utils.dart.parsedate_to_datetime``.
    """
    if value is None:
        return None
...
def http_date(
    ...
    This is a wrapper for :func:`email.utils.dart.format_datetime`. It
    ...
    .. versionchanged:: 2.0
        Use ``email.utils.dart.format_datetime``. Accept ``date`` objects.
    """
